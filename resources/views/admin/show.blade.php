                ...
                <div class="card">
                    ...
                    <div class="col-sm-12 col-lg-7">
                        <div class="card-body">
                            ...
                            <a class="btn ms_btn_secondary mr-2 mb-3" href="{{ route('admin.plates.index') }}">Gestisci i tuoi piatti</a>
                            <a class="btn btn-primary mb-3" href="{{ route('admin.orders.index') }}">Visualizza i tuoi ordini</a>
                        </div>
                    </div>
                    </div>
                </div>
