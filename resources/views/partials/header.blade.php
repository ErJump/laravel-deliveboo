    ...
    <nav class="navbar navbar-dark navbar-expand-lg px-5">
        <div class="container-fluid d-flex">
            <a class="navbar-brand" href="#">
                <img class="d-none d-sm-none d-md-none d-lg-block d-xl-block" src="{{asset('images/logo-white.png')}}" alt="logo">
                <img class="d-block d-sm-block d-md-block d-lg-none d-xl-none" src="{{asset('images/logo-small.png')}}" alt="logo-small">
            </a>
